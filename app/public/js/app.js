...
angular.module('app').controller('ColorPickerCtrl', ["$scope", "$timeout", "apiService", "colorHelper", "light1Color", "light2Color", function(
  $scope,
  $timeout,
  apiService,
  colorHelper,
  ...
  $stateProvider
    .state('colorPicker', {
      ...
      resolve: {
        ...
        light2Color: ["$q", "apiService", "colorHelper", function(
          $q,
          apiService,
          colorHelper
        ) {
